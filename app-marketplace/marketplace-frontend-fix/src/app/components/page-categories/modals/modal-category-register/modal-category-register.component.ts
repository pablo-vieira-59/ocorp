...
@Component({
	selector: 'app-modal-category-register',
	templateUrl: './modal-category-register.component.html',
	styleUrls: ['./modal-category-register.component.scss']
})
export class ModalCategoryRegisterComponent {
	loading = false;
	modalRef?: BsModalRef;
